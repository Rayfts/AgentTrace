...
AgentTrace is an open-source engineering project. We want discussion, review, and collaboration to stay useful, respectful, and safe for everyone participating.

## Expected behavior

- Discuss code, telemetry evidence, and ideas on their merits.
...
- Protect private information, credentials, and sensitive trace data.
...
This policy applies to issues, pull requests, reviews, discussions, project-managed community spaces, and direct project interactions connected to AgentTrace.
