...
- Desktop observed-only charts for token usage, event distribution, and event duration evidence.
...
- Replay exact allowlisting remains the execution gate; risk tags make likely side effects visible rather than broadening authorization.
